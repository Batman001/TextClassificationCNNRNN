...
class TRNNConfig(object):
    ...
    print_per_batch = 100     # 每隔100批数据输出一次结果
    save_per_batch = 10       # 每隔10批保存运算结果
...
class TextRNN(object):
    ...
    def rnn(self):
        ...
        def dropout():    # 为每一个RNN核后面添加一个Dropout层
        ...
        with tf.name_scope("rnn"):
            ...
            _outputs, _ = tf.nn.dynamic_rnn(rnn_cell, inputs=embedding_inputs, dtype=tf.float32)
